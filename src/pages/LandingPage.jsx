...
export default function LandingPage() {
    ...
    return (
        <>
            <div className="hidden lg:block font-sans relative overflow-x-hidden">
                {/* ==========================
                            NAVBAR
                ========================== */}
                <nav className="fixed top-0 left-0 w-full z-50 bg-[#F4F6FA] shadow-md">
                    <div className="w-full max-w-[1800px] mx-auto flex items-center justify-between px-4 sm:px-6 md:px-10 h-[70px] md:h-[80px] lg:h-[90px]">
                        ...
                        <div className="hidden md:flex gap-4 md:gap-5 lg:gap-8 font-semibold text-[13px] md:text-[14px] lg:text-[16px] tracking-wide mx-auto">
                            <a href="/login" className="text-black hover:text-[#3066BE] transition">{texts[langCode].community}</a>
                            <a href="/login" className="text-black hover:text-[#3066BE] transition">{texts[langCode].vacancies}</a>
                            <a href="/login" className="text-black hover:text-[#3066BE] transition">{texts[langCode].chat}</a>
                            <a href="/login" className="text-black hover:text-[#3066BE] transition">{texts[langCode].companies}</a>
                        </div>
            ...
            bg-[#3066BE] text-white w-[90px] h-[35px] sm:w-[100px] sm:h-[38px] md:w-[120px] md:h-[42px]
            rounded-md hover:bg-[#274f94] transition

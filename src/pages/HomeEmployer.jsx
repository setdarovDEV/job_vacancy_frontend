                ...
                <div className="w-full bg-white border border-[#AEAEAE] mt-[67px] h-[1006px] rounded-[25px] overflow-hidden">
                    ...
                    <div className="lg:w-2/3 w-[1094px] max-h-[700px] overflow-y-auto overflow-x-hidden ml-[45px] mt-[25px] flex flex-col mb-[137px] pr-2">
                        {vacancies.results.map((vacancy, index) => (
                            <div key={index} className="rounded-xl p-6 transition">
                                ...
                                <div className="flex items-center justify-between mb-2 w-full">
                                    <button
                                        ...
                                        className="text-2xl ml-[-28px] font-bold text-black bg-white border-none hover:text-[#3066BE] transition-colors duration-200 text-left"
                                    >
                                        {vacancy.title}
                                    </button>

                                    <div className="flex gap-2 mr-[-21px]">
                                        {/* Edit tugma */}
                                        <div
                                            onClick={() => {
                                                if (isEditable) handleEdit(vacancy);
                                            }}
                                            className={`w-[30px] h-[30px] rounded-full flex items-center justify-center transition 
                                                ${isEditable
                                                ? "border-[#3066BE] cursor-pointer bg-white hover:bg-[#3066BE]/10"
                                        ...
                                        <div
                                            onClick={() => {
                                                if (isEditable) handleDelete(vacancy.id);
                                            }}
                                            className={`w-[30px] h-[30px] rounded-full flex items-center justify-center transition 
                                                ${isEditable
                                                ? "border-[#3066BE] cursor-pointer bg-white hover:bg-[#3066BE]/10"
                                ...
                                <p className="text-gray-500 mb-4 break-words whitespace-pre-wrap w-full">
                                    {vacancy.description}
                                </p>
                                ...
                                <div className="flex items-center gap-14 text-gray-400 text-sm mt-2">
                                    {/* Fixed / Hourly badge */}

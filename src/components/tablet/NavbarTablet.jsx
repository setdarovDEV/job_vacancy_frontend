...
export default function NavbarTablet() {
    ...
    return (
        <div className="relative w-full bg-[#F4F6FA] h-[60px] flex items-center mb-[-65px] justify-between px-4 shadow-sm border-b border-[#e5e5e5]">
            ...
            <div className="flex items-center gap-4 relative">
                ...
                <button
                    ...
                    className="px-4 py-1.5 bg-[#3066BE] text-white rounded-md text-sm font-semibold hover:bg-[#2556a3] transition"
                >
                    Войти
                </button>
            </div>
            ...
            {open && (
                <div className="absolute top-[60px] left-0 w-full bg-[#F4F6FA] shadow-md z-10 px-6 py-4 flex flex-col gap-4">
                    <Link to="#" className="text-black hover:text-[#3066BE] text-base">
                        Сообщество
                    </Link>
                    <Link to="#" className="text-black hover:text-[#3066BE] text-base">
                        Вакансии
